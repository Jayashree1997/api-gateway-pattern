...
//            track.setId(2);
//            track.setName("Jonny");
//            track.setComments("dgahsashdhsd");
//            list = new ArrayList();
//            list.add(track);
//        }
//
...
//            when(trackService.getTrackById(10)).thenThrow(TrackNotFoundException.class);
...
//            when(trackService.getTrackByName(any())).thenReturn((List<Track>) track);
//            mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/tracks/xyz")
//                    .contentType(MediaType.APPLICATION_JSON).content(asJsonString(track)))
//                    .andExpect(MockMvcResultMatchers.status().isFound())
//                    .andDo(MockMvcResultHandlers.print());
//        }
